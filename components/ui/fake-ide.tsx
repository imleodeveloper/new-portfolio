...
const EXPERIENCE_LINES = [
  ...
  'const trajetoria = [',
  '  {',
  '    empresa: "Group Orbis Digital",',
  '    cargo: "Socio & Dev Full-Stack",',
  '    periodo: "2025 - presente",',
  '    desc: [',
  '      "Sites, CRM e apps web/mobile",',
  '      "Integracoes WhatsApp API e Telegram",',
  '      "Automacoes e ecossistema digital",',
  '    ],',
  '  },',
  '  {',
