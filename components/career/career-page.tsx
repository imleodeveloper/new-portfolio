...
const CAREER = [
  {
    company: "Group Orbis Digital",
    role: "Sócio & Desenvolvedor Full-Stack",
    period: "2025 – Presente",
    duration: "Atual",
    logo: null as string | null,
    color: "#8b5cf6",
    description: "Sócio e desenvolvedor full-stack responsável por sites, CRM, aplicativos e todo o ecossistema digital da empresa.",
    details: [
      "Desenvolvimento de sites institucionais e landing pages",
      "CRM Group Orbis: kanban, gestão de leads e controle financeiro",
      "Aplicativos web e mobile (Android/iOS)",
      "Integração WhatsApp API oficial e Baileys",
      "Telegram via GramJS e Telethon",
    ],
    skills: ["Next.js", "React", "PHP", "MySQL", "WhatsApp API"],
  },
  {
    ...
    logo: null as string | null,
    color: "#10b981",
    description: "Sócio e desenvolvedor focado em sistemas internos, CRM, área de membros, landing pages, automações e integrações de API.",
    details: [
